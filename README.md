...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/fastsrm-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11110&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/fastsrm-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `fastsrm` can be installed with:

```
conda install fastsrm
```

It is possible to list all of the versions of `fastsrm` available on your platform with:
